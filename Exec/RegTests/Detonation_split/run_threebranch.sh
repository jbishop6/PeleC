#!/bin/bash
#SBATCH --job-name=three_branch
#SBATCH --output=slurm_output_three_branch%j.log
#SBATCH --error=slurm_error_three_branch%j.log
...
OUTDIR="ThreeBranch_outputs"
mkdir -p "$OUTDIR"

# === Run PeleC with two-branch input file ===
./PeleC2d.gnu.MPI.ex input_detonation_three_branch.inp
